    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (existingProduct != null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('منتج بالباركود "$_barcode" موجود مسبقاً!'),
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        ...
                        validator:
                            AppValidators.required('يرجى إدخال الباركود'),
                ...
                TextFormField(
                  ...
                  validator: AppValidators.required('يرجى إدخال الاسم'),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const InputLabel(text: 'الكمية في المخزون'),
                          TextFormField(
