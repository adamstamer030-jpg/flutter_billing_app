              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'ستظهر هذه البيانات على الإيصالات الرقمية والمطبوعة.',
                    ...
                    const SizedBox(height: 15),
                    const InputLabel(text: 'معرف الدفع (UPI)'),
                    _buildTextField(
                    ...
                    Row(
                      ...
                      children: [
                        const InputLabel(text: 'نص ذيل الإيصال'),
                        Text('الحد الأقصى 150 حرف',
                            style: TextStyle(
                    ...
                    _buildTextField(
                      ...
                      hint: 'شكراً لزيارتكم، نراكم مجدداً!',
                      maxLines: 2,
                      maxLength: 60,
                    ),
                  ],
