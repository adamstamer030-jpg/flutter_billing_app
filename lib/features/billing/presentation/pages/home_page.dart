      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Text(
              'قم بتشغيل الكاميرا لبدء مسح الرموز الشريطية والعناصر تلقائياً.',
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Text('العناصر الممسوحة',
                            style: TextStyle(
                                fontSize: 18, fontWeight: FontWeight.w600)),
                        Text('$totalItems عنصر إجمالي',
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Text(
              'ستظهر العناصر الممسوحة هنا عند مسحها بالكاميرا أعلاه.',
              textAlign: TextAlign.center,
